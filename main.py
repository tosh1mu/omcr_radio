...
tokumei_channel = channel.Channel(
    ...
    "Tokumei Radio",
    "Just personal use.",
    "https://podcast.namikibashi.net/img/tokumei_logo.jpg",
...
onsei_channel = channel.Channel(
    ...
    "Onsei Housou",
    "Just personal use.",
    "https://podcast.namikibashi.net/img/onsei_logo.jpg",
...
mnf_channel = channel.Channel(
    ...
    "MNF",
    "Just personal use.",
    "https://podcast.namikibashi.net/img/mnf_logo.jpg",
...
now_channel = channel.Channel(
    ...
    "NOW",
    "Just personal use.",
    "https://podcast.namikibashi.net/img/now_logo.jpg",
...
ariari_channel = channel.Channel(
    ...
    "Ari Ari",
    "Just personal use.",
    "https://podcast.namikibashi.net/img/ariari_logo.jpg",
